...
if ($_GET['id'] > 0 && !empty($_GET['id'])) 
{
	...
	$single_prod_data = $mysqli->query("select proid, name,price,detail,single_img,AddedOn,mul_img from products where proid = '".$_GET['id']."' limit 1  ");
...
<div class="col-lg-12 order-1 order-lg-2">
							...
							<div class="tab-pane tab-pane-navigation active" id="formsStyleDefault">
								...
								<h4 class="mb-3"><?= !empty($pro_id) && $pro_id > 0 ? 'Update Product' : 'Add Product' ?></h4>
								<div class="card mb-4">
									<div class="card-body">
										<div class="row">
											<div class="col">
											  	<form class="contact-form" action="add_product.php" method="POST" class="needs-validation" novalidate="novalidate" enctype="multipart/form-data">
													...
													<div class="row">
														<div class="form-group col-lg-6">
															<label class="form-label text-color-dark text-3">Product Name</label>
															<input type="text" data-msg-required="Please enter your name." maxlength="100" class="form-control text-3 h-auto py-2" name="name" required="" value="<?= !empty($pro_id) && $pro_id > 0 ? $single_row['name']  : '' ?>" >
														</div>
														<div class="form-group col-lg-6">
															<label class="form-label mb-1 text-2">Product Category</label>
															<input type="text"  data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control text-3 h-auto py-2" name="price" required="" value="<?= !empty($pro_id) && $pro_id > 0 ? $single_row['price']  : '' ?>">
														</div>
													</div>
													...
													<div class="row">
														<div class="form-group col">
															...
															<textarea maxlength="5000" data-msg-required="Please Use Text Editor" rows="8" class="form-control text-3 h-auto py-2 summernote" name="detail" required=""><?= !empty($pro_id) && $pro_id > 0 ? $single_row['detail']  : '' ?></textarea>
														</div>
													</div>
                                                    ...
                                                    <div class="row">
														<div class="form-group col-lg-6">
															...
															<input type="file" value="" data-msg-required="Single Image" maxlength="100" class="form-control text-3 h-auto py-2" name="single_img" required="">
														...
														<div class="form-group col-lg-6">
															...
															<input type="file" value="" data-msg-required="Multiple Image" data-msg-email="Please enter a valid email address." maxlength="100" class="form-control text-3 h-auto py-2" name="mul_img[]" multiple required="">
														<p>Note- Image size: 800 x 800</p>
														<?= $multiple_images; ?>
                                                        </div>
													</div>

													<?php if (!empty($pro_id) && $pro_id > 0) {?>
														<input type="hidden" name="proid" value="<?= !empty($pro_id) && $pro_id > 0 ? $single_row['proid']  : '' ?>" />
														<input type="hidden" name="opt" value="edit" />
													<?php } ?>
											
													<div class="row">
														<div class="form-group col">
															<input type="submit" value="<?= !empty($pro_id) && $pro_id > 0 ? 'Update Product' : 'Add Product' ?>" name="submit" class="btn btn-primary" data-loading-text="Loading...">
														</div>
													</div>
												</form>
											</div>
